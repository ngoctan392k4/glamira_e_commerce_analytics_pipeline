...
def save_pid_error_429(pid, tag, link, path="data/error/pid_error_429.jsonl"):
    os.makedirs(os.path.dirname(path), exist_ok=True)
    ...
    logging.info(f"Have saved pid_error 404 with {pid} into data/error/pid_error_429.jsonl")
